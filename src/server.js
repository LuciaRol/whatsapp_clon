...
const io = socketIo(server, {
    cors: {
      origin: "https://chat-lucia-lucias-projects-4febd059.vercel.app:3000",
      methods: ["GET", "POST"]
    },
    ...
    if (profilePicture) {
        ...
        profilePicture.mv(path.join(__dirname, 'uploads', fileName), (err) => {
            if (err) {
                ...
                const imageUrl = `https://chat-lucia-lucias-projects-4febd059.vercel.app/:4000/uploads/${fileName}`;
